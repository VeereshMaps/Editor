...
export const MenuBar = ({ editor, createThread,
    handleImageUpload, handleImportClick, handleImportFilePick, importRef, editionsById, handleApprovalClick, actionType, sideBarMenu, suggestionLength, fontSize, fontFamilyFunc, decreaseFont, increaseFont }) => {
