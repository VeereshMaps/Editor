...
export default function AuthLogin({ isDemo = false }) {
    ...
    useEffect(() => {
        console.log("deployment done till here 21-08-2025");
                ...
                {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                    <form noValidate onSubmit={handleSubmit}>
                        <Grid container spacing={3}>
                            ...
                            {errors.submit && (
                                <Grid item xs={12}>
                                    <FormHelperText error>{typeof errors.submit === "string" ? errors.submit : errors.submit?.message || "An error occurred"}</FormHelperText>
                                </Grid>
                            )}
                            <Grid item xs={12}>
                                <AnimateButton>
